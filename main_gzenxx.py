...
if __name__ == '__main__':
    # 解压压缩包
    rar_root_dir = "F:\\workspace\\www.rar_gzenxx.com"
    ...
    for rar_file in rar_files:
        ...
        try:
            decompress_rar(rar_file_path, "F:\\workspace\\www.gzenxx.com\\www.gzenxx.com")
        except Exception as e:
            print(e)
            continue
        print("==========" + "解压完成" + "==========")
    exit()
    #
    root_dir = "F:\\workspace\\www.gzenxx.com\\www.gzenxx.com"
    ...
    for file in files:
        ...
        docx_dir = "F:\\workspace\\www.gzenxx.com\\docx.www.gzenxx.com\\"
        ...
        if os.path.exists(docx_file):
            ...
            finish_dir = "F:\\workspace\\www.gzenxx.com\\finish.www.gzenxx.com\\"
