...
if __name__ == '__main__':
    ...
    root_dir = "E:\\workspace\\topedu.ybep.com.cn\\20250919\\topedu.ybep.com.cn"
    ...
    for category in category_dirs:
        if category in category_dirs_arr:
            ...
            for file in files:
                ...
                finish_dir = "E:\\workspace\\topedu.ybep.com.cn\\20250919\\finish.topedu.ybep.com.cn\\" + category
                if not os.path.exists(finish_dir):
                    os.makedirs(finish_dir)
                file_type = file.split(".")[1]
                print(file_type)
                if file_type.find("pdf") != -1:
                    # 是pdf文件，直接转到finish文件夹
                ...
                docx_dir = "E:\\workspace\\topedu.ybep.com.cn\\20250919\\docx.topedu.ybep.com.cn\\" + category
