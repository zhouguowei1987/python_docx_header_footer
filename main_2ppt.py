...
if __name__ == '__main__':
    root_dir = "F:\\workspace\\www.2ppt.com\\2026-05-10\\www.2ppt.com"
    finish_dir = "F:\\workspace\\www.2ppt.com\\2026-05-10\\www.finish_2ppt.com"
    ...
    for file in files:
        ...
        if not os.path.exists(finish_file_path):
            ...
            for slide in prs.slides:
                # 替换文本
                replace_text_in_slide(slide, '爱PPT', 'XXXX')
                replace_text_in_slide(slide, '2ppt', 'XXXX')
                replace_text_in_slide(slide, '2PPT', 'XXXX')
            # 删除最后一页
