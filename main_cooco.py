...
if __name__ == '__main__':
    ...
    root_dir = "E:\\workspace\\bk.cooco.net.cn\\bk.cooco.net.cn\\初中"
    ...
    for category in category_dirs:
        if category in category_dirs_arr:
            ...
            for file in files:
                ...
                print(file_path)
                docx_dir = "E:\\workspace\\bk.cooco.net.cn\\bk.docx_cooco.net.cn\\初中\\" + category
                ...
                if os.path.exists(docx_file):
                    # continue
                    finish_dir = "E:\\workspace\\bk.cooco.net.cn\\bk.finish_cooco.net.cn\\初中\\" + category
